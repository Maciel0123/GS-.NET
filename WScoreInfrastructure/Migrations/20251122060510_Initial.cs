    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "NVARCHAR2(36)", nullable: false),
                    Nome = table.Column<string>(type: "NVARCHAR2(100)", nullable: false),
                    Email = table.Column<string>(type: "NVARCHAR2(150)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Feedback = table.Column<string>(type: "NVARCHAR2(500)", nullable: false),
